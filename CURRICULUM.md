...
1. **BRIEF** — write `docs/briefs/lesson-NN.md`: the Couchbase concept, why it
   maps to this librarian code, official doc links, and the exact
   files/signatures Matt will write. `docs/briefs/README.md` has the section
   structure and why each section is there — follow it rather than improvising,
   and add to it when a lesson teaches you something about briefing.
...
Moved to [`docs/briefs/lesson-01.md`](docs/briefs/lesson-01.md) — briefs live in
that archive now; the record below stays here.
